...
firebase.database().ref().orderByChild('License Key').equalTo(userLicense).once("value", function(snapshot) {
    snapshot.forEach(function(data) {
      ...
      var adminHTML = 
		...
		<link rel="stylesheet" type="text/css" href="https://s3.amazonaws.com/themefiend/capsule-theme/' + (typeof environment != 'undefined' ? environment : '') + 'admin/admin_capsule-theme.css"/>';
